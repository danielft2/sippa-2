...
const FormLogin = () => {
   const singInForm = useForm<SinInFormData>({ resolver: zodResolver(singInScheme) });
               ...
               <Form.Field>
                  ...
                  <Controller 
                     ...
                     render={({field: { onChange, ref, value } }) => {
                        return <Form.Select ref={ref} value={value} onValueChange={onChange}/>
                     }}
                  />
               ...
               <Form.Field className="flex flex-col mb-4">
                  ...
                  <Form.Field className="flex justify-between items-center mt-2">
                     <Form.Field className="flex items-center gap-2">
                        ...
                        <label htmlFor="remember" className="text-xs text-gray-500">Lembrar informações</label>
                     </Form.Field>
                     <button className="self-end text-xs text-green-400">Esqueceu a senha?</button>
                  </Form.Field>
               </Form.Field>
